...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'leadcapture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title', 'leadcapture' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'leadcapture' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'leadcapture' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'leadcapture' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'leadcapture' ),
			]
		);
