...
use CwAddons\Modules\Woocommerce\Widgets\Products;
...
class Skin_Classic extends Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/ink-wc-products/section_woocommerce_layout/after_section_start', [ $this, 'register_controls' ] );
	...
	public function get_title() {
		return esc_html__( 'Classic', 'colorway-addons' );
	}
