...
namespace CwAddons\Modules\DefaultSlider\Widgets;
...
class DefaultSlider extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Default Slider', 'colorway-addons');
    }
...
//            ],
            'selectors' => [
                '{{WRAPPER}} .ink-slideshow .ink-slideshow-content-wrapper1' => 'max-width: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
